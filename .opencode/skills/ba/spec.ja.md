...
name: ba:spec
description: >
  生要件を構造化されたビジネス仕様書に変換。
  トリガー: 「仕様を書く」「仕様を作成」「要件を分析」「業務仕様」「requirements doc を作成」、または /ba:spec と入力時。
---
## 概要

生要件を構造化されたビジネス仕様書に変換。 トリガー: 「仕様を書く」「仕様を作成」「要件を分析」「業務仕様」「requirements doc を作成」、または /ba:spec と入力時。
...
**目的**: 生要件（メール、議事録、Jira チケットなど）を構造化された業務仕様書に変換し、開発の単一の真実源を確立。
