...
name: sm:standup
description: >
  生入力から日次スタンドアップを迅速に集約・フォーマット、ブロッカーとスプリントヘルスをハイライト。
  トリガー: 「スタンドアップをまとめる」「日次スタンドアップをフォーマット」「daily scrum」「今日のスタンドアップ」「チームアップデートをペースト」、または /sm:standup と入力時。
---

# /sm:standup
**ロール**: Scrum Master
**目的**: チームメンバーの生入力（Slack/Teams ペースト）から日次スタンドアップ集約 — メンバー別 Yesterday/Today/Blockers、スプリントヘルスハイライト。
