...
マージ前の構造化セキュリティレビュー。3 段階: Always / Ask First / Never + OWASP Top 10 チェックリスト。 トリガー: 「セキュリティレビュー」「セキュリティ確認」「マージ前セキュリティチェック」「OWASP チェック」「セキュリティスキャン」「セキュリティ問題ないか」、または /sec:review と入力時。
