...
スプリントレトロスペクティブのファシリテーション、テーマ別フィードバック集約、アクション可能なアクションアイテム作成。 トリガー: 「スプリントレトロ」「retrospective」「スプリント末ミーティング」「スプリント総括」「what went well」「レトロからアクションアイテム」、または /sm:retro と入力時。
