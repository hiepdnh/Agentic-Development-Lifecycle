...
仕様と UT 結果から Integration/E2E テストプランを作成し、人手 E2E 実行と結果記録をサポート。 /qa:ut 通過後にのみ実行。失敗時は dev:debug へのバグフィードバックループあり。 トリガー: 「ITプラン作成」「統合テスト」「E2Eテストケース」「インテグレーションテスト」「エンドツーエンドテスト」、または /qa:it と入力時。
