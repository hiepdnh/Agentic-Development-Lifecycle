...
description: >
  ...
  Trigger when: user says "review code", "review before merge", "code review", "check my code",
  "review implementation", "review trước merge", "kiểm tra code", or types /dev:review.
---
