...
question({
  questions: [{
    question: "Security review xong. Có 'Ask First' items cần confirm với senior?",
    header: "Senior OK?",
    options: [
      { label: "Cần confirm", description: "Có Ask First items cần senior review" },
      { label: "Clean", description: "Không có security concern, OK to merge" },
    ]
  }]
})
