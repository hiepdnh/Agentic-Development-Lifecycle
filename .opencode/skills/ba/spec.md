...
<!-- Gate: Làm rõ trước khi soạn spec -->
question({
  questions: [{
    question: "Trước khi tôi soạn spec, tôi cần làm rõ: Business rule nào chưa rõ?",
    header: "Business rule",
    options: [
      { label: "Đã rõ", description: "Business rule đã đủ, tiếp tục soạn spec" },
      { label: "Cần giải thích", description: "Tôi sẽ mô tả business rule chi tiết hơn" },
      { label: "Khác", description: "Tự nhập câu hỏi" }
    ]
  }, {
    question: "Edge case hoặc exception nào cần lưu ý?",
    header: "Edge case",
    options: [
      { label: "Không có", description: "Không có edge case đặc biệt" },
      { label: "Có", description: "Tôi sẽ mô tả edge case" }
    ]
  }, {
    question: "Có tích hợp với hệ thống khác không?",
    header: "Tích hợp",
    options: [
      { label: "Có", description: "Có tích hợp — mô tả hệ thống" },
      { label: "Không", description: "Không có tích hợp" }
    ]
  }]
})
...
<!-- Gate cuối: Review spec -->
question({
  questions: [{
    question: "Có business rule nào tôi bỏ sót không?",
    header: "BR missing",
    options: [
      { label: "Không, đủ rồi", description: "Business rules đã đầy đủ" },
      { label: "Có — thêm", description: "Tôi sẽ mô tả business rule còn thiếu" }
    ]
  }, {
    question: "AC có đủ cụ thể để QA test được không?",
    header: "AC quality",
    options: [
      { label: "Đủ rồi", description: "Acceptance Criteria đã đủ chi tiết" },
      { label: "Cần chi tiết hơn", description: "Tôi sẽ chỉ ra AC nào cần bổ sung" }
    ]
  }, {
    question: "Có Open Question cần resolve trước khi đưa Dev không?",
    header: "Open Q",
    options: [
      { label: "Không", description: "Không có câu hỏi mở" },
      { label: "Có", description: "Tôi sẽ nêu câu hỏi cần resolve" }
    ]
  }]
})
