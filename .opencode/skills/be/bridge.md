...
Hỗ trợ Bridge Engineer dịch yêu cầu khách hàng Nhật, tạo tài liệu song ngữ JP-VN, chuẩn bị deliverables theo chuẩn Nhật (設計書, 単体テスト仕様書, 成果物). Trigger khi: user nói "dịch yêu cầu JP", "tạo 設計書", "soạn tài liệu cho khách Nhật", "bridge engineer", "JP requirement", "translate JP spec", hoặc gõ /be:bridge.
...
question({
  questions: [{
    question: "Loại tài liệu cần tạo là gì?",
    header: "Loại tài liệu",
    options: [
      { label: "基本設計書", description: "Basic Design — spec cấp cao, confirm với JP trước khi dev" },
      { label: "詳細設計書", description: "Detail Design — spec chi tiết cho dev VN" },
      { label: "単体テスト仕様書", description: "UT Spec — test cases format chuẩn JP" },
      { label: "変更依頼", description: "Change Request — dùng /be:changerequest để có approval trail" },
      { label: "障害報告書", description: "Incident Report — báo cáo bug/incident" }
    ]
  }, {
    question: "Input language là gì?",
    header: "Input lang",
    options: [
    ...
    question: "Output cần loại nào?",
    header: "Output",
    options: [
      { label: "Song ngữ JP+VN", description: "Tạo cả 2 ngôn ngữ" },
      { label: "JP only", description: "Chỉ tiếng Nhật" },
      { label: "VN only", description: "Chỉ tiếng Việt" }
    ]
  }]
})
...
<!-- Gate: Xác nhận hướng xử lý làm rõ -->
question({
  questions: [{
    question: "Bạn muốn xử lý các điểm chưa rõ thế nào?",
    header: "Hướng xử lý",
    options: [
      { label: "Gửi câu hỏi cho JP", description: "Có — gửi câu hỏi cho JP trước" },
      { label: "Tiếp tục với assumptions", description: "Không — tiếp tục với assumptions đã nêu" },
      { label: "Khác", description: "Tự nhập hướng xử lý khác" }
    ]
  }]
})
...
<!-- Gate cuối: Review checklist -->
question({
  questions: [{
    question: "Checklist song ngữ đã hoàn tất? Confirm để finalize?",
    header: "Finalize",
    options: [
      { label: "Xác nhận", description: "Tài liệu đã sẵn sàng để gửi" },
