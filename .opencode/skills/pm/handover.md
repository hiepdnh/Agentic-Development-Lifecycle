...
Đọc `E:\AI Bootcamp\ClaudeSkill\templates\jp-vn-en-glossary.md` trước khi viết bất kỳ thuật ngữ kỹ thuật nào.
...
```
Nguồn đọc:
- E:\AI Bootcamp\ClaudeSkill\docs\baseline\codebase-overview.md (nếu có)
- E:\AI Bootcamp\ClaudeSkill\docs\decisions\ADR-*.md — tất cả ADRs
- E:\AI Bootcamp\ClaudeSkill\docs\tasks\*\requirements.md — open/in-progress tasks
- E:\AI Bootcamp\ClaudeSkill\docs\workflows\sprint-lifecycle.md
- E:\AI Bootcamp\ClaudeSkill\templates\jp-vn-en-glossary.md
...
- Sau khi merge, update `E:\AI Bootcamp\ClaudeSkill\docs\workflows\role-guide.md` nếu contact matrix thay đổi
