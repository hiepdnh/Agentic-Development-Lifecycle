...
タスク検証 + マージ後にベースライン文書（画面 + API）を更新。各タスクの最終ステップ。 トリガー: 「文書を更新」「ベースラインを更新」「タスク完了後文書更新」「マージ後文書を同期」「画面文書を更新」「API 文書を更新」、または /docs:update と入力時。
...
**テンプレート**:
- `templates/baseline-screen.ja.md`
- `templates/baseline-api.ja.md`
- `templates/verification.ja.md`
